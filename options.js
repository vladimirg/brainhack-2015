...
function save_options() {
  chrome.storage.sync.set({
    ...
    shouldHighlightOnHover: document.getElementById('should-highlight-on-hover').value,
...
function restore_options() {
  chrome.storage.sync.get({
    ...
    shouldHighlightOnHover: 'nothing',
    ...
    document.getElementById('should-highlight-on-hover').value = items.shouldHighlightOnHover;
